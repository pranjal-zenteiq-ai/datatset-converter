"""
Transformer script for: meta-math/MetaMathQA
...
PLAN = {
    ...
    "notes": [
        "The 'original_question' column is ignored as it's not part of the conversation flow between user and assistant",
        "The 'type' column is ignored as it's metadata"
    ],
