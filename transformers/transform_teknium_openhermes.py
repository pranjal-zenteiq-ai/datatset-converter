"""
Transformer script for: teknium/OpenHermes-2.5
...
PLAN = {
    ...
    "notes": [
        "The 'conversations' field contains the main conversation as a list of message dicts with 'from' and 'value' keys.",
        "The 'from' key values 'human' and 'gpt' map to 'user' and 'assistant' roles respectively.",
        "The 'value' key contains the message content.",
        "The 'weight' field in conversation items should be ignored for conversation formatting.",
        "The top-level 'system_prompt' field should be included as a system message if non-null, preceding the conversation list."
    ],
