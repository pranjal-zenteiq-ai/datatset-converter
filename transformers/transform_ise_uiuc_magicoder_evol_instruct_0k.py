"""
Transformer script for: ise-uiuc/Magicoder-Evol-Instruct-110K
...
PLAN = {
    ...
    "notes": [
        "Dataset contains simple two-turn conversations with 'instruction' as user query and 'response' as assistant answer",
        "No system messages or tool messages present in the data",
        "All content values are plain strings containing code and/or explanatory text",
        "Conversation flow is consistently user turn followed by assistant turn"
    ],
