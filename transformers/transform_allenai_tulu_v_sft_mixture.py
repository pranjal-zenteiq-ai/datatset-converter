"""
Transformer script for: allenai/tulu-v2-sft-mixture
...
PLAN = {
    ...
    "field_to_role": {},
    "notes": [
        "Entire conversation stored in 'messages' field as list of role-content pairs",
        "Only 'user' and 'assistant' roles present in sample data",
        "Extra columns 'dataset' and 'id' are non-conversation metadata and will be ignored",
        "Source message order is preserved in the list structure"
    ],
